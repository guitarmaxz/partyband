        ...
        <div class="menu">
            ...
            <div class="icos">
                <ul class="content-icos">
                    <li class="ico-menu">
                        <a href="#"><img src="{{asset('imgs/ico/home.png')}}" alt="home"></a>
                        <a href="#"><img class="ico-red" src="{{asset('imgs/ico/home_red.png')}}" alt="home"></a>
                    </li>
                    <li class="ico-menu">
                    ...
                    <li class="ico-menu dropdown">
                        <a href="{{route('perfil')}}"><img src="{{asset('imgs/ico/perfil.png')}}" alt="perfil"></a>
                        <a href="{{route('perfil')}}"><img class="ico-red" src="{{asset('imgs/ico/perfil_red.png')}}" alt="perfil"></a>
